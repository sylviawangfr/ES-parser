...
public class ESEngineNestedObject {

    String index = "ibmnested3";

    private Logger logger = LogManager.getLogger(ESEngineNestedObject.class);

    public ESEngineNestedObject withIndex(String newIndex) {
        this.index = newIndex;
        return this;
    }
